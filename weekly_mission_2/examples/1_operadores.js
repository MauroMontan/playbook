...
console.log(users); // sorted ascendin// Ejemplo 1: for Each para imprimir elementos de una lista
...
//   country.toUpperCase().slice(0, 3) // el método slice obtiene solo la longitud marcada del
//   string
//   )
//   console.log("Ejemplo 6: Uso de map para convertir todos los nombres de una lista
//   a mayúsculas")
//   console.log(countriesFirstThreeLetters)
//
//   // Ejemplo 7: Uso de filter para filtrar una lista de elementos
...
//                 const numbers9 = [1, 2, 3, 4, 5]
//                 const result_of_reduce = numbers9.reduce((acc, element) => acc + element, 0)
//                 console.log("Ejemplo 9: Uso de reduce para calcular la suma de los elementos de
//                 una lista")
//                 console.log(result_of_reduce)
//
//                 // Ejemplo 10: uso de every nos ayuda a validar todos los elementos de una
//                 lista, si todos cumplen con la validación que indiques te regresa true, de lo
//                 contrario false
//                 const names10 = ['Explorer 1', 'Explorer 2', 'Explorer 3', 'Explorer 4']
//                 const areAllStr = names10.every((name) => typeof name === 'string') // every
//                 console.log("Ejemplo 10: Son todos los nombres string: " + areAllStr)
...
//                           const names13 = ['Explorer 1', 'Explorer 2', 'Explorer 3']
//                           const result = names13.findIndex((name) => name.length > 7)
//                           console.log("Ejemplo 13: Primer elemento cuya palabra sea mayor
//                           a 7 esta en la posición "+ result)
//
...
//                                         })
//
//                                         console.log("Ejemplo 16: Ordenando una lista de
//                                         objetos por la edad")
//                                         console.log(users) // sorted ascendingg
